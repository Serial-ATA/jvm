...
pub fn latestUserDefinedLoader0(_env: JniEnv, _class: &'static Class) -> Reference /* java.lang.ClassLoader */
{
	unimplemented!("jdk.internal.misc.VM#latestUserDefinedLoader0")
}
pub fn getuid(_env: JniEnv, _class: &'static Class) -> s8 {
	unimplemented!("jdk.internal.misc.VM#getuid")
}
pub fn geteuid(_env: JniEnv, _class: &'static Class) -> s8 {
	unimplemented!("jdk.internal.misc.VM#geteuid")
}
pub fn getgid(_env: JniEnv, _class: &'static Class) -> s8 {
	unimplemented!("jdk.internal.misc.VM#getgid")
}
pub fn getegid(_env: JniEnv, _class: &'static Class) -> s8 {
	unimplemented!("jdk.internal.misc.VM#getegid")
}
pub fn getNanoTimeAdjustment(_env: JniEnv, _class: &'static Class, _offset: s8) -> s8 {
	unimplemented!("jdk.internal.misc.VM#getNanoTimeAdjustment")
}
pub fn getRuntimeArguments(_env: JniEnv, _class: &'static Class) -> Reference /* String[] */
{
	unimplemented!("jdk.internal.misc.VM#getRuntimeArguments")
}
pub fn initialize(_env: JniEnv, _class: &'static Class) {
