...
pub fn latestUserDefinedLoader0(_env: NonNull<JniEnv>) -> Reference /* java.lang.ClassLoader */ {
	unimplemented!("jdk.internal.misc.VM#latestUserDefinedLoader0")
}
pub fn getuid(_env: NonNull<JniEnv>) -> s8 {
	unimplemented!("jdk.internal.misc.VM#getuid")
}
pub fn geteuid(_env: NonNull<JniEnv>) -> s8 {
	unimplemented!("jdk.internal.misc.VM#geteuid")
}
pub fn getgid(_env: NonNull<JniEnv>) -> s8 {
	unimplemented!("jdk.internal.misc.VM#getgid")
}
pub fn getegid(_env: NonNull<JniEnv>) -> s8 {
	unimplemented!("jdk.internal.misc.VM#getegid")
}
pub fn getNanoTimeAdjustment(_env: NonNull<JniEnv>, _offset: s8) -> s8 {
	unimplemented!("jdk.internal.misc.VM#getNanoTimeAdjustment")
}
pub fn getRuntimeArguments(_env: NonNull<JniEnv>) -> Reference /* String[] */ {
	unimplemented!("jdk.internal.misc.VM#getRuntimeArguments")
}
pub fn initialize(_env: NonNull<JniEnv>) {
