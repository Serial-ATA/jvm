...
pub fn getCDSConfigStatus(_: NonNull<JniEnv>, _class: &'static Class) -> jint {
	// TODO: Bitfield of:
...
pub fn logLambdaFormInvoker(_: NonNull<JniEnv>, _class: &'static Class, _line: Reference) {
	unimplemented!("jdk.internal.misc.CDS#logLambdaFormInvoker")
}

pub fn initializeFromArchive(_: NonNull<JniEnv>, _this_class: &'static Class, _class: Reference) {
	// TODO
}
...
pub fn getRandomSeedForDumping(_: NonNull<JniEnv>, _class: &'static Class) -> jlong {
	// TODO: https://github.com/openjdk/jdk/blob/af564e46b006fcd57ec7391cd1438b3b9311b1d6/src/hotspot/share/prims/jvm.cpp#L3696
	0
}

pub fn dumpClassList(_: NonNull<JniEnv>, _class: &'static Class, _list_file_name: Reference) {
	unimplemented!("jdk.internal.misc.CDS#dumpClassList")
}
pub fn dumpDynamicArchive(
	_: NonNull<JniEnv>,
	_class: &'static Class,
	_archive_file_name: Reference,
) {
