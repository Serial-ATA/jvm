...
impl ClassAccessFlags {
	...
	pub const ACC_FINAL     : ClassAccessFlags = Self(0x0010);
	/// Treat superclass methods specially when invoked by the `invokespecial` instruction.
	pub const ACC_SUPER     : ClassAccessFlags = Self(0x0020);
	/// Is an interface, not a class.
	pub const ACC_INTERFACE : ClassAccessFlags = Self(0x0200);
	/// Declared abstract; must not be instantiated.
	pub const ACC_ABSTRACT  : ClassAccessFlags = Self(0x0400);
	/// Declared synthetic; not present in the source code.
	pub const ACC_SYNTHETIC : ClassAccessFlags = Self(0x1000);
	/// Declared as an annotation interface.
	pub const ACC_ANNOTATION: ClassAccessFlags = Self(0x2000);
...
impl MethodAccessFlags {
	...
	pub const ACC_PRIVATE     : MethodAccessFlags = Self(0x0002);
	/// Declared protected; may be accessed within subclasses.
	pub const ACC_PROTECTED   : MethodAccessFlags = Self(0x0004);
	/// Declared static. */
	pub const ACC_STATIC      : MethodAccessFlags = Self(0x0008);
	/// Declared final; must not be overridden (§5.4.5).
	pub const ACC_FINAL       : MethodAccessFlags = Self(0x0010);
	/// Declared synchronized; invocation is wrapped by a monitor use.
	// TODO: This is not respected anywhere
	pub const ACC_SYNCHRONIZED: MethodAccessFlags = Self(0x0020);
	/// A bridge method, generated by the compiler.
	pub const ACC_BRIDGE      : MethodAccessFlags = Self(0x0040);
	/// Declared with variable number of arguments.
	pub const ACC_VARARGS     : MethodAccessFlags = Self(0x0080);
	/// Declared native; implemented in a language other than the Java programming language.
	pub const ACC_NATIVE      : MethodAccessFlags = Self(0x0100);
	/// Declared abstract; no implementation is provided.
	pub const ACC_ABSTRACT    : MethodAccessFlags = Self(0x0400);
...
impl FieldAccessFlags {
	...
	/// Declared private; accessible only within the defining class and other classes belonging to the same nest (§5.4.4).
	pub const ACC_PRIVATE  : FieldAccessFlags = Self(0x0002);
	/// Declared protected; may be accessed within subclasses.
	pub const ACC_PROTECTED: FieldAccessFlags = Self(0x0004);
	/// Declared static.
	pub const ACC_STATIC   : FieldAccessFlags = Self(0x0008);
	/// Declared final; never directly assigned to after object construction (JLS §17.5).
	pub const ACC_FINAL    : FieldAccessFlags = Self(0x0010);
	/// Declared volatile; cannot be cached.
	pub const ACC_VOLATILE : FieldAccessFlags = Self(0x0040);
	/// Declared transient; not written or read by a persistent object manager.
	pub const ACC_TRANSIENT: FieldAccessFlags = Self(0x0080);
	/// Declared synthetic; not present in the source code.
